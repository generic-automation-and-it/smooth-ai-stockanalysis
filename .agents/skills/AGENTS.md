...
| 2026-07-23 | Vendored the `git-commit-review-push` supporting skill from `smooth-ai-report-review` and registered it in local skill indexes/settings. One local delta (commit-made guard) — see `git-commit-review-push/AGENTS.md` for the upstream-bound diff. | |
