...
- Free to swap PostgreSQL for SQLite, remove the orchestration and container dependency, rename throughout, and restructure at will — with no future merge cost.
