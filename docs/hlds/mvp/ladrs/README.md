...
| # | Decision | Status |
|---|---|---|
| [LADR-001](001-clean-architecture-with-vertical-slices.md) | Clean architecture with vertical feature slices | Accepted |
| [LADR-002](002-on-disk-sqlite-over-in-memory-snapshots.md) | On-disk SQLite over in-memory with periodic snapshots | Accepted |
...
| [LADR-006](006-one-time-fork-of-template.md) | One-time fork of the development template | Accepted |
| [LADR-007](007-visible-docs-folder.md) | Visible documentation folder | Accepted |
