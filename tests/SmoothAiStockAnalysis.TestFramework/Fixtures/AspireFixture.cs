...
public sealed class AspireFixture : IAsyncLifetime
{
    ...
    private const string PostgresContainerName = "smooth-ai-stockanalysis-test-postgres";
    private const string RedisContainerName = "smooth-ai-stockanalysis-test-redis";
    private const string WireMockContainerName = "smooth-ai-stockanalysis-test-wiremock";
        ...
        try
        {
            ...
            try
            {
                var appHost = await DistributedApplicationTestingBuilder
                    .CreateAsync<Projects.SmoothAiStockAnalysis_TestFramework_Aspire>(["--no-dashboard"], cts.Token);
