...
internal static class DistributedApplicationBuilderExtensions
{
    ...
    internal static void AddSmoothAiStockAnalysisTestDependencies(this IDistributedApplicationBuilder builder)
    {
        ...
        IResourceBuilder<ParameterResource> postgresPassword)
    {
        var postgres = builder.AddPostgres("postgres", password: postgresPassword, port: 15432)
            .WithContainerName("smooth-ai-stockanalysis-test-postgres")
            .WithContainerRuntimeArgs(
                "--label", $"com.docker.compose.project={DockerDesktopGroupName}",
                "--label", "com.docker.compose.service=smooth-ai-stockanalysis-test-postgres")
    ...
    private static void AddRedisDependency(this IDistributedApplicationBuilder builder)
    {
        builder.AddRedis("redis", port: 16379)
            .WithContainerName("smooth-ai-stockanalysis-test-redis")
            .WithContainerRuntimeArgs(
                "--label", $"com.docker.compose.project={DockerDesktopGroupName}",
                "--label", "com.docker.compose.service=smooth-ai-stockanalysis-test-redis")
            .WithLifetime(ContainerLifetime.Persistent);
    }
    ...
    private static void AddWireMockDependency(this IDistributedApplicationBuilder builder)
    {
        builder.AddContainer("wiremock", "wiremock/wiremock")
            ...
            .WithContainerName("smooth-ai-stockanalysis-test-wiremock")
            .WithContainerRuntimeArgs(
                "--label", $"com.docker.compose.project={DockerDesktopGroupName}",
                "--label", "com.docker.compose.service=smooth-ai-stockanalysis-test-wiremock")
            .WithLifetime(ContainerLifetime.Persistent);
    }
}
